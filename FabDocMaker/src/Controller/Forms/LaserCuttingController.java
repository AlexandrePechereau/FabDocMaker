...
import View.Forms.LaserCuttingForm;
...
public class LaserCuttingController {
private ArrayList<String> strlist;

	private CreatePDF_LaserCutting cpdf;
	private Color LIGHT_RED = new Color(250,102,102);
	
	public LaserCuttingForm laserCutting;
	...
	public LaserCuttingController(){
		laserCutting = new LaserCuttingForm();
		
		textfieldlist = laserCutting.getTextfieldlist();
		...
		if(!laserCutting.getENOUGH_SCREEN_HEIGHT()){
			
			Next_Button_1 = laserCutting.getNext_Button_1();
			Next_Button_1.addActionListener(operationPanel2Listener);
			Previous_Button_1 = laserCutting.getPrevious_Button_1();
			Previous_Button_1.addActionListener(operationPanel1Listener);
			Next_Button_2 = laserCutting.getNext_Button_2();
			Next_Button_2.addActionListener(operationPanel3Listener);
			Previous_Button_2 = laserCutting.getPrevious_Button_2();
			Previous_Button_2.addActionListener(operationPanel2Listener);
			frame2 = laserCutting.getFrame2();
			frame3 = laserCutting.getFrame3();
		}
		Save_Button = laserCutting.getSave_Button();
		Save_Button.addActionListener(operationSaveListener);
		Next_Button = laserCutting.getNext_Button();
		Next_Button.addActionListener(operationNextListener);
		frame = laserCutting.getFrame();
	...
	private void saveButton(File file, ArrayList<String> strlist, ArrayList<Image> imagelist) throws DocumentException, MalformedURLException, IOException{
		...
		cpdf = new CreatePDF_LaserCutting(file, this.strlist, imagelist);
	}
	...
	private ActionListener operationNextListener = new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if(next == true) imload = new ImageLoaderController(infos, "LaserCutting");
		}
	};
