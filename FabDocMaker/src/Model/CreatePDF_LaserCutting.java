...
public class CreatePDF_LaserCutting {
	...
	private PdfPTable createFrontPageTable(ArrayList<String> infos) {
        ...
        cell2 = new PdfPCell(new Phrase("Material you used :"));
        cell3 = new PdfPCell(new Phrase("Material Brand :"));
        cell4 = new PdfPCell(new Phrase("Material thickness :"));
        cell5 = new PdfPCell(new Phrase("Material dimensions :"));
        cell6 = new PdfPCell(new Phrase("Vector color :"));
        cell7 = new PdfPCell(new Phrase("Vector Speed :"));
        cell8 = new PdfPCell(new Phrase("Vector Power :"));
        cell9 = new PdfPCell(new Phrase("Vector frequency :"));
        cell10 = new PdfPCell(new Phrase("Raster Color :"));
        cell11 = new PdfPCell(new Phrase("Raster Speed :"));
        cell12 = new PdfPCell(new Phrase("Raster Power :"));
        cell13 = new PdfPCell(new Phrase("Cut width of the laser :"));
        cell14 = new PdfPCell(new Phrase("Laser Focusing :"));
        cell15 = new PdfPCell(new Phrase("Job Resolution :"));
        cell16 = new PdfPCell(new Phrase("Files were designed by You :"));
        cell17 = new PdfPCell(new Phrase("Files were downloaded from :"));
        cell18 = new PdfPCell(new Phrase("Files were downloaded and modified by you :"));
        cell19 = new PdfPCell(new Phrase("Software used to draw this 2D object :"));
        cell20 = new PdfPCell(new Phrase("Software used to send your job to the laser-cutter :"));
